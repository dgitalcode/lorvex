...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-[var(--shadow-lift)] transition ease-[cubic-bezier(0.22,1,0.36,1)] data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
